...
export default function Footer() {
  return (
    <footer className="mb-16 selectionsFooter">
      <ul className="text-xs sm:text-sm md:text-base mt-6 md:mt-8 flex text-gray-700 dark:text-gray-300 flex-row space-x-4 space-y-0 ">
        <li>
          <a
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://drive.google.com/file/d/1bl6MF5ACDhjCWSFnBBn61yhX5udMXAgY/view?usp=sharing"
          >
            <FileIcon />
