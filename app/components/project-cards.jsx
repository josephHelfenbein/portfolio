  ...
  return (
    ...
    <div className="flex items-start justify-start gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img src="https://img.shields.io/badge/igdb%20api-9147FF?logo=igdb&style=for-the-badge&logoColor=white" />
          </div>
          <h5 className="text-sm tracking-tighter">United Hacks V3 submission (weekend)</h5>
          <h5 className="text-sm tracking-lighter">Winner for Best Solo Hack 🎉</h5>
          <div className="flex gap-0.5">
  ...
  return (
    ...
    <div className="flex items-start justify-start gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img src="https://img.shields.io/badge/A%E2%80%93frame-EF2D5E?logo=a-frame&style=for-the-badge&logoColor=white" />
          ...
          <h5 className="text-sm tracking-tighter">DivHacks 2024 submission (weekend)</h5>
          <div className="flex gap-0.5">
          ...
          <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
            <linearGradient xmlns="http://www.w3.org/2000/svg" id="prefix__paint0_linear_12_232" x1="5.833" y1="25.421" x2="25.632" y2="5.567" gradientUnits="userSpaceOnUse"><stop stop-color="#FF761C"/><stop offset=".98" stop-color="#FFF9F5"/></linearGradient>
            </defs>
          </svg>
      ...
      <div className="block h-full rounded-lg p-2">
          <div className="p-3 text-sm font-medium text-gray-900">
            <p className="p-2">MendPath combines therapy, technology, and social connection in a way that fosters empathy, accountability, and mental health progress for users, filling a crucial gap in both personal well-being and community support. </p>
          </div>
      </div>
    </article>
  </div>
    ...
    <h3 className="text-xl font-semibold tracking-tighter">TravelAmulet</h3>
      ...
      <div className="flex items-start justify-between gap-5">
          ...
          <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
            ...
            <img src="https://img.shields.io/badge/openai%20api-black?logo=openai&style=for-the-badge&logoColor=white" />
            <img src="https://img.shields.io/badge/Flask-4590A1?logo=flask&style=for-the-badge&logoColor=white" />
            <img src="https://img.shields.io/badge/google%20maps%20api-4285F4?logo=google%20maps&style=for-the-badge&logoColor=white" />
            ...
            <h5 className="text-sm tracking-tighter">TiDB Hackathon 2024 submission (1 month)</h5>
            <div className="flex gap-0.5">
