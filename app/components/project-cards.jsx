  ...
  return (
    ...
    <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/javascript-yellow?logo=javascript&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/webgl-red?logo=webgl&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/Bootstrap-563D7C?style=for-the-badge&logo=bootstrap&logoColor=white" />
          </div>
...
export function GameRecommendCard(){
  return (
    ...
    <div className="flex items-start justify-center gap-2">
      ...
      <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/Next.js-000000?style=for-the-badge&logo=next.js&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/Tailwind%20CSS-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/openai%20api-black?logo=openai&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/igdb%20api-9147FF?logo=igdb&style=for-the-badge&logoColor=white" />
          </div>
  ...
  return (
    ...
    <div className="flex items-start justify-center gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/A%E2%80%93frame-EF2D5E?logo=a-frame&style=for-the-badge&logoColor=white" />
  ...
  return (
    ...
    <div className="flex items-start justify-center gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/Tailwind%20CSS-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/cloudflare%20workers-F38020?style=for-the-badge&logo=cloudflare%20workers&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/Hume%20AI-000000.svg?logo=data:image/svg%2bxml;base64,&style=for-the-badge" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/supabase-3FCF8E?logo=supabase&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/clerk-6C47FF?logo=clerk&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/spotify%20api-1DB954?logo=spotify&style=for-the-badge&logoColor=white" />
  ...
  return (
    ...
    <div className="flex items-start justify-center gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/expo-000000?style=for-the-badge&logo=expo&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/flask-4590A1?logo=flask&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/amazon%20rds-527FFF?style=for-the-badge&logo=amazon%20rds&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/cloudflare%20workers-F38020?style=for-the-badge&logo=cloudflare%20workers&logoColor=white" />
          </div>
    ...
    <h3 className="text-xl font-semibold tracking-tighter">TravelAmulet</h3>
      ...
      <div className="flex items-start justify-between gap-5">
          ...
          <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
            ...
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB" />
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/Bootstrap-563D7C?style=for-the-badge&logo=bootstrap&logoColor=white" />
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/Three.js-black?logo=three.js&style=for-the-badge&logoColor=white" />
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/Flask-4590A1?logo=flask&style=for-the-badge&logoColor=white" />
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/openai%20api-black?logo=openai&style=for-the-badge&logoColor=white" />
            <img className="h-6 md:h-7" src="https://img.shields.io/badge/google%20maps%20api-4285F4?logo=google%20maps&style=for-the-badge&logoColor=white" />
...
export function ScienceProjectCard(){
  return (
    ...
    <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/python-3776AB?style=for-the-badge&logo=python&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/tensorflow-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white" />
          ...
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/pandas-150458?style=for-the-badge&logo=pandas&logoColor=white" />
          </div>
...
export function HorrorGameProjectCard(){
  return (
    ...
    <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
      <img className="h-6 md:h-7" src="https://img.shields.io/badge/c++-00599C?logo=cplusplus&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/unreal%20engine-black?logo=unreal%20engine&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/steamworks%20api-1b2838?style=for-the-badge&logo=steam&logoColor=white" />
          </div>
  ...
  return (
    ...
    <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/unity%20engine-black?logo=unity&style=for-the-badge&logoColor=white" />
  ...
  return (
    ...
    <div>
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/c%23-68217A.svg?logo=data:image/svg%2bxml;base64,&style=for-the-badge" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/unity%20engine-black?logo=unity&style=for-the-badge&logoColor=white" />
          <img className="h-6 md:h-7" src="https://img.shields.io/badge/steamvr-1b2838?style=for-the-badge&logo=steam&logoColor=white" />
          </div>
