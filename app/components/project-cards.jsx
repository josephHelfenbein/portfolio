...
export function PhysicsProjectCard(){
  return (
    <div className="flex justify-center m-4 p-4 shadow-lg rounded-xl" style={{height:'380px'}}>
...
export function MaterialProjectCard(){
  return (
    <div className="flex justify-center p-4 m-4 shadow-lg rounded-xl" style={{height:'380px'}}>
    <article className="w-4xl">
    <div className="flex items-start justify-center gap-2">
  ...
  return (
    ...
    <div className="flex items-start justify-center gap-2">
      ...
      <div className="flex flex-wrap items-start justify-start gap-1 pt-2 pb-3">
          ...
          <img src="https://img.shields.io/badge/clerk-6C47FF?logo=clerk&style=for-the-badge&logoColor=white" />
          <img src="https://img.shields.io/badge/spotify%20api-1DB954?logo=spotify&style=for-the-badge&logoColor=white" />
...
export function HelpSignalProjectCard(){
  return (
    <div className="flex justify-center m-4 p-4 rounded-xl shadow-lg" style={{height:'380px'}}>
    <article className="w-4xl">
    <div className="flex items-start justify-center gap-2">
...
export function E3ProjectCard( ){
  return (
    <div className="flex justify-center p-5" style={{height:'380px'}}>
